...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-white shadow-2xl rounded-2xl p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="mt-2 space-y-1">
              <p className={`text-xs ${passwordCriteria.length ? 'text-green-600' : 'text-gray-500'}`}>✓ At least 8 characters</p>
              <p className={`text-xs ${passwordCriteria.letter ? 'text-green-600' : 'text-gray-500'}`}>✓ Contains at least one letter</p>
              <p className={`text-xs ${passwordCriteria.number ? 'text-green-600' : 'text-gray-500'}`}>✓ Contains at least one number</p>
            </div>
          </div>
